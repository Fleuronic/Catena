...
public protocol Storage {
	...
	func fetch<Model: Catena.Model>(_ type: Model.Type, with id: Model.ID) async -> Result<Model.ID?, StorageError>
	...
	func delete<Model: Catena.Model>(_ type: Model.Type, where predicate: Predicate<Model>?) async -> Result<Void, StorageError>
	func delete<Model: Catena.Model>(_ type: Model.Type, with id: Model.ID) async -> Result<Void, StorageError>
}
